...
/obj/item/borg/upgrade/bluespace_light_replacer
	name = "janitor cyborg bluespace light replacer upgrade"
	desc = "An advanced light replacer upgrade board with bluespace properties that can be attached to janitorial cyborgs."
	icon_state = "cyborg_upgrade4"
	require_module = TRUE
	module_type = /obj/item/robot_module/janitor
	items_to_replace = list(
		/obj/item/lightreplacer = /obj/item/lightreplacer/bluespace
	)
